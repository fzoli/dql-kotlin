 ...
 */
package com.farcsal.dql.query.parser.order.resolver

import com.farcsal.query.api.OrderField
import com.farcsal.query.api.StringOrderField
import java.util.*

class DqlOrderFieldExpressionLocalizedResolver(
    ...
    override fun getExpression(field: String): OrderField {
        val orderField = delegate.getExpression(field)
        if (orderField is StringOrderField) {
            return orderField.withLocale(locale)
        }
        return orderField
    }
