...
internal class DqlStringBuilderVisitorUnary(
    ...
    override operator fun not(): DqlStringBuilderVisitor {
        return DqlStringBuilderVisitorUnary(
            negated = !negated, field = field, method = method
        )
    }

    override fun visit(builder: DqlStringBuilder) {
        builder.appendUnaryCriteria(negated, field, method)
    }

    override fun toString(): String {
        return (if (negated) "!" else "") + "$field.$method()"
    }
