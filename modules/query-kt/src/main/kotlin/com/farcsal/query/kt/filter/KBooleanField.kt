...
class KBooleanField(val value: Boolean?) : BooleanField {

    private val criteria = KCriteria.of(value)
    ...
    override fun and(right: Criteria): Criteria {
        return criteria.and(right)
    }

    override fun or(right: Criteria): Criteria {
        return criteria.or(right)
    }
    ...
    override fun isTrue(): Criteria {
        return KCriteria.of(value != null && value)
    }
