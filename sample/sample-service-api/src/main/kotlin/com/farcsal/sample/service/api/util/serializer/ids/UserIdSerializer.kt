 ...
 */
package com.farcsal.sample.service.api.util.serializer.ids

import com.farcsal.sample.repository.api.user.model.UserId
import com.farcsal.sample.repository.api.user.model.asUserId
import com.farcsal.sample.service.api.util.serializer.UuidSerializer
...
object UserIdSerializer : KSerializer<UserId> {
    ...
    override fun deserialize(decoder: Decoder): UserId {
        return UuidSerializer.deserialize(decoder).asUserId()
    }

    override fun serialize(encoder: Encoder, value: UserId) {
        UuidSerializer.serialize(encoder, value.uuid)
    }
